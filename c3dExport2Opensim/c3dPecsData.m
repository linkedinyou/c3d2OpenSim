function [mkrStruct,trialName, dataPath,analogRate,sampleRate,First,Last] =  c3dPecsData(hTrial,allTime)
...
if allTime 
    First=double(invoke(hTrial, 'FirstValidTrajectoryFieldNum'));
    Last=double(invoke( hTrial, 'LastValidTrajectoryFieldNum'));
...
for i = 1:nMarkers
    ...
    index = invoke( hTrial, 'FindTrajectoryIndex', mkrName, 0 );
